...
## Contents
- run.py — `workflows/create-wiki/scripts/run.py` — Main scaffold script. Creates all wiki directories and files, updates wikis/CONTEXT.md and README.md, and appends to LOG files.
...
- Updated `wikis/CONTEXT.md` — New wiki entry added to Contents section.
- Updated `README.md` — New wiki entry added to Wikis section, Last updated date refreshed.
...
## Dependencies
- `workflows/create-wiki/wiki-context.md.template` — Template used to generate the new wiki's root CONTEXT.md.
- `wikis/CONTEXT.md` — Updated by the script on every run.
- `README.md` (root) — Updated by the script on every run.
