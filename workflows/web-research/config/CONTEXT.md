...
## Contents
- sources.yaml — `workflows/web-research/config/sources.yaml` [[workflows/web-research/config/CONTEXT]] — Default source priority order and enabled/disabled settings; overridden per-run with --include and --exclude flags.
...
## Dependencies
- `skills/web-research/scripts/research.py` [[skills/web-research/scripts/CONTEXT]] — The SOURCE_REGISTRY in research.py must contain all source names listed in sources.yaml.
