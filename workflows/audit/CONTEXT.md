...
- tests/ — `workflows/audit/tests/` [[workflows/audit/tests/CONTEXT]] — Unit tests for the knowledge-graph, encoding-guard, and personal-data-guard audit-hook merge helpers and their graceful-degradation paths, plus the subdirectory filter and a one-command runner.
