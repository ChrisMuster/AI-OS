...
**Reading memory:** Step 4 of session startup loads `memory/MEMORY.md`. Once the task is known (step 12), read the MEMORY.md index and pull any individual memory files whose topics relate to the current task before beginning work. Do not defer this until mid-session.
