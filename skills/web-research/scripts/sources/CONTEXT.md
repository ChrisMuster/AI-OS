...
- scraper_source.py — `skills/web-research/scripts/sources/scraper_source.py` [[skills/web-research/scripts/sources/CONTEXT]] — trafilatura-based scraper; direct URL content extraction.
