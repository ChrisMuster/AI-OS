...
## Contents
- Web Research — `skills/web-research/` — Fetches and packages web research from multiple sources; importable by any workflow.
- Image Prompt — `skills/image-prompt/` — Analyses written content and produces an image recommendation (real photo, stock photo, or AI-generated) plus the appropriate output for the chosen path.
...
## Dependencies
- `CLAUDE.md` (root) — Defines the shared skills convention, the CONTEXT.md schema, and the promotion rules for workflow-scoped skills.
